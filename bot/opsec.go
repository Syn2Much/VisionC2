...
func mew() byte      { return byte(0x10 ^ 0xF0) }  // patched by setup.py
func mewtwo() byte   { return byte(0xF4 ^ 0xF1) }  // patched by setup.py
func celebi() byte   { return byte(0x2A ^ 0x99) }  // patched by setup.py
func jirachi() byte  { return byte(0x60 ^ 0x11) }  // patched by setup.py
func shaymin() byte  { return byte(0xC9 ^ 0x05) }  // patched by setup.py
func phione() byte   { return byte(0x40 ^ 0x88) }  // patched by setup.py
func manaphy() byte  { return byte(0x08 ^ 0xCB) }  // patched by setup.py
func victini() byte  { return byte(0x73 ^ 0x38) }  // patched by setup.py
func keldeo() byte   { return byte(0x18 ^ 0xB9) }  // patched by setup.py
func meloetta() byte { return byte(0xF3 ^ 0x63) }  // patched by setup.py
func genesect() byte { return byte(0x75 ^ 0x57) }  // patched by setup.py
func diancie() byte  { return byte(0xF7 ^ 0x6E) }  // patched by setup.py
func hoopa() byte    { return byte(0x1C ^ 0x56) }  // patched by setup.py
func volcanion() byte { return byte(0xFD ^ 0xE5) }  // patched by setup.py
func magearna() byte { return byte(0xED ^ 0xF2) }  // patched by setup.py
func marshadow() byte { return byte(0xB3 ^ 0xE5) }  // patched by setup.py
func zeraora() byte  { return byte(0xFC ^ 0x31) }  // patched by setup.py
func zarude() byte   { return byte(0x82 ^ 0x9B) }  // patched by setup.py
func regieleki() byte { return byte(0x2F ^ 0xF8) }  // patched by setup.py
func regidrago() byte { return byte(0xA1 ^ 0xA0) }  // patched by setup.py
func glastrier() byte { return byte(0x77 ^ 0x28) }  // patched by setup.py
func spectrier() byte { return byte(0xB3 ^ 0x67) }  // patched by setup.py
func calyrex() byte  { return byte(0xFF ^ 0x99) }  // patched by setup.py
func wyrdeer() byte  { return byte(0x9B ^ 0x9B) }  // patched by setup.py
func kleavor() byte  { return byte(0xEF ^ 0xBD) }  // patched by setup.py
func ursaluna() byte { return byte(0x91 ^ 0x64) }  // patched by setup.py
func basculegion() byte { return byte(0x09 ^ 0xBA) }  // patched by setup.py
func sneasler() byte { return byte(0x78 ^ 0xE0) }  // patched by setup.py
func overqwil() byte { return byte(0x8C ^ 0x5F) }  // patched by setup.py
func enamorus() byte { return byte(0xB6 ^ 0xAE) }  // patched by setup.py
func tinkaton() byte { return byte(0x62 ^ 0x85) }  // patched by setup.py
func annihilape() byte { return byte(0x45 ^ 0x70) }  // patched by setup.py
