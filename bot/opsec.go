...
func mew() byte      { return byte(0x23 ^ 0x91) }  // patched by setup.py
func mewtwo() byte   { return byte(0xCB ^ 0xAA) }  // patched by setup.py
func celebi() byte   { return byte(0x2C ^ 0x65) }  // patched by setup.py
func jirachi() byte  { return byte(0xC9 ^ 0x27) }  // patched by setup.py
func shaymin() byte  { return byte(0x89 ^ 0x9C) }  // patched by setup.py
func phione() byte   { return byte(0x92 ^ 0xD3) }  // patched by setup.py
func manaphy() byte  { return byte(0xF0 ^ 0xA8) }  // patched by setup.py
func victini() byte  { return byte(0x1E ^ 0x55) }  // patched by setup.py
func keldeo() byte   { return byte(0x6F ^ 0x6E) }  // patched by setup.py
func meloetta() byte { return byte(0xE0 ^ 0x86) }  // patched by setup.py
func genesect() byte { return byte(0x1B ^ 0x2F) }  // patched by setup.py
func diancie() byte  { return byte(0xE2 ^ 0x71) }  // patched by setup.py
func hoopa() byte    { return byte(0xC8 ^ 0xD6) }  // patched by setup.py
func volcanion() byte { return byte(0xEE ^ 0x1F) }  // patched by setup.py
func magearna() byte { return byte(0xD7 ^ 0xBC) }  // patched by setup.py
func marshadow() byte { return byte(0x3D ^ 0x61) }  // patched by setup.py
func zeraora() byte  { return byte(0x1A ^ 0x7E) }  // patched by setup.py
func zarude() byte   { return byte(0x44 ^ 0xC9) }  // patched by setup.py
func regieleki() byte { return byte(0xFD ^ 0x1D) }  // patched by setup.py
func regidrago() byte { return byte(0x9F ^ 0xC4) }  // patched by setup.py
func glastrier() byte { return byte(0xD0 ^ 0xDE) }  // patched by setup.py
func spectrier() byte { return byte(0x8E ^ 0x16) }  // patched by setup.py
func calyrex() byte  { return byte(0x97 ^ 0xCE) }  // patched by setup.py
func wyrdeer() byte  { return byte(0xFB ^ 0xBB) }  // patched by setup.py
func kleavor() byte  { return byte(0x0F ^ 0x35) }  // patched by setup.py
func ursaluna() byte { return byte(0x6D ^ 0x78) }  // patched by setup.py
func basculegion() byte { return byte(0xD3 ^ 0x43) }  // patched by setup.py
func sneasler() byte { return byte(0x6A ^ 0x08) }  // patched by setup.py
func overqwil() byte { return byte(0x09 ^ 0xFC) }  // patched by setup.py
func enamorus() byte { return byte(0x7F ^ 0xA3) }  // patched by setup.py
func tinkaton() byte { return byte(0x68 ^ 0x81) }  // patched by setup.py
func annihilape() byte { return byte(0x8A ^ 0xAC) }  // patched by setup.py
